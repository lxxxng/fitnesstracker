...
# # --------------------------------------------------------------
# # Calculating set duration (not used anymore)
# # --------------------------------------------------------------
...
# dont keep runnning this to prevent duplicates
...
# --------------------------------------------------------------
# Dealing with overlapping windows (correlation)
# --------------------------------------------------------------
...
df_cluster.to_pickle("../../data/interim/03_data_faetures.pkl")