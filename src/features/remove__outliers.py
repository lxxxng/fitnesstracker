...
for col in outlier_columns:
    for label in df["label"].unique():
        ...
        outliers_removed_df.loc[(outliers_removed_df["label"] == label) & dataset[col + "_outlier"], col] = np.nan
        
        # Calculate the number of removed outliers by counting True values in the outlier column
